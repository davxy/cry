...
const char g_long_value_bin[8] = { 0x01,0x23,0x45,0x67,0x89,0xab,0xcd,0xef };

const char g_a8_bin[1] = { 0x12 };
const char g_b8_bin[1] = { 0x21 };
const char g_c8_bin[1] = { 0xF0 };
const char g_a8_b8_add_bin[1] = { 0x33 };
const char g_a8_c8_add_bin[2] = { 0x01, 0x02 };
